...
const ACTION_HANDLERS = {
  ...
  "view.hidden":         async () => toggleDotfiles(),
  ...
  "tab.reopen":          async () => restoreClosedTab(),
...
function initCommands() {
  ...
  { id:"view.hidden", label: t('cmd.toggleHidden'), action: toggleDotfiles, keys:"Ctrl+H" },
  { id:"view.hiddenAttr", label: t('cmd.toggleHiddenAttr'), action: toggleHiddenAttr },
  { id:"view.system", label: t('cmd.toggleSystem'), action: toggleSystem },
  ...
  { id:"tab.reopen", label: t('cmd.reopenTab'), action: restoreClosedTab, keys:"Ctrl+Shift+T" },
