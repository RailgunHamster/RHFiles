...
Object.assign(_builtinEn, {
  ...
  'notice.pathsCopied': '{count} paths copied',
  'ctx.copyPaths': 'Copy {count} Paths',
  'cmd.copyPaths': 'Copy selected paths',
...
function fallbackCall(cmd, args) {
  ...
  switch (cmd) {
    ...
    case "open_in_windows_explorer": return null;
