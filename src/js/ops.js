...
function showContextMenu(x, y, isRight) {
  ...
  const items = [
    ...
    { label: isDir ? t('ctx.openFolderInBrowser') : t('ctx.openContainingFolderInBrowser'), action: () => runContextCommand('open_folder_in_default_browser', {path: sel[0].path, is_directory: isDir}, isDir ? t('ctx.openFolderInBrowser') : t('ctx.openContainingFolderInBrowser')), disabled: !singleSelection },
...
function showTabContextMenu(x, y, tabId, isRight) {
  ...
  showMenuAt(x, y, [
    ...
    { label: t('ctx.openFolderInBrowser'), action: () => runContextCommand('open_folder_in_default_browser', {path: folderPath, is_directory: true}, t('ctx.openFolderInBrowser')), disabled: folderPath === 'home://' },
...
function showPathContextMenu(x, y, path, isDir, isRight) {
  ...
  const items = [
    ...
    { label: isDir ? t('ctx.openFolderInBrowser') : t('ctx.openContainingFolderInBrowser'), action: () => runContextCommand('open_folder_in_default_browser', {path, is_directory: isDir}, isDir ? t('ctx.openFolderInBrowser') : t('ctx.openContainingFolderInBrowser')) },
