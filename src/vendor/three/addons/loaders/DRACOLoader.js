...
const WASM_BIN_URL = new URL( 'vendor/three/addons/libs/draco/draco_decoder.wasm', document.baseURI ).toString();
const WASM_JS_URL = new URL( 'vendor/three/addons/libs/draco/draco_wasm_wrapper.js', document.baseURI ).toString();
const JS_URL = new URL( 'vendor/three/addons/libs/draco/draco_decoder.js', document.baseURI ).toString();

const DRACO_GLTF_CONFIG = {
	js: new URL( 'vendor/three/addons/libs/draco/gltf/draco_wasm_wrapper.js', document.baseURI ).toString(),
	wasm: new URL( 'vendor/three/addons/libs/draco/gltf/draco_decoder.wasm', document.baseURI ).toString(),
};
