...
| 2 | **文件操作进度条** | ⭐⭐⭐ | 大文件复制/移动时的进度显示 |
| 3 | **文件夹变化实时监听** | ⭐⭐ | `notify` crate 替代 3 秒轮询 |

### P1 — 重要功能

| # | 功能 | 难度 | 说明 |
|---|------|------|------|
| 4 | **云存储同步状态** | ⭐⭐⭐ | OneDrive/Google Drive 同步图标 |
| 5 | **NTFS 权限编辑** | ⭐⭐⭐⭐ | ACL 权限编辑器 |
| 6 | **MTP 设备浏览** | ⭐⭐⭐⭐ | 手机/相机 MTP 协议 |
| 7 | **FTP 连接** | ⭐⭐⭐ | FTP/FTPS 文件浏览 |
| 8 | **SMB 网络浏览** | ⭐⭐⭐ | 局域网共享 |
| 9 | **多窗口** | ⭐⭐ | Tauri 多窗口支持 |
| 10 | **系统托盘** | ⭐⭐ | 最小化到托盘 |
| 11 | **7z 压缩** | ⭐⭐ | 7z 格式支持 |
...
| 13 | **媒体预览播放** | ⭐⭐ | 音视频内嵌播放 |
| 14 | **PDF 预览** | ⭐⭐ | PDF 渲染 |
| 15 | **Rich Text 预览** | ⭐⭐⭐ | RTF/DOCX 渲染 |
| 16 | **Home Widget 系统** | ⭐⭐⭐ | 主页快速访问卡片 |
| 17 | **每文件夹布局偏好** | ⭐⭐ | SQLite 存储 |
...
|---|------|
| 18 | 自定义主题上传 |
| 19 | Mica/Acrylic 半透明背景 |
| 20 | QuickLook/Seer Pro 集成 |
| 21 | 格式化驱动器 |
| 22 | 证书安装 |
| 23 | EXE 兼容性设置 |
| 24 | 工具栏按钮自定义 |
| 25 | 自适应布局 |
| 26 | Git Clone (含 GitHub OAuth) |
| 27 | 单实例管理 |
| 28 | 协议激活 (files://) |
| 29 | 自动更新 |
| 30 | Sentry 错误上报 |
...
| # | 功能 |
|---|------|
| 31 | SQLite 替代 JSON 持久化 |
| 32 | DI 容器 / Action 命令系统 |
| 33 | 自然排序 (数字感知) |
| 34 | ADS (NTFS 备用数据流) 标签 |
| 35 | MSIX 打包 |
